exports.handler = async(event) => {
  try {
      ...
      totalDecks * 52
    } cards minus ${hand.size} previously delt cards) to deal ${handSize} cards for ${totalHands} players.`,
              }),
              headers: {
                  "content-type": "application/json",
              },
      ...
      return {
          ...
          body: JSON.stringify({
              success: false,
              hand: null,
              message: "'previous_cards' must be an array of strings or an array of arrays of strings",
          }),
          headers: {
              "content-type": "application/json",
          }
